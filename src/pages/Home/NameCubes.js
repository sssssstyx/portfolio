...
const NameCubes = () => {
    return (
        <div>
            <div className="absolute -top-10 -left-20 md:top-0 md:left-6 lg:left-6 scale-[0.85] scale-[0.6] md:scale-90 lg:scale-125 xl:scale-150 -rotate-[30deg]">
                <Spline scene="https://prod.spline.design/w-Szef4PquzPhaEj/scene.splinecode" />
            </div>
            <div className="absolute top-0 -right-16 md:-top-6 md:right-6 lg:-top-12 lg:right-36 scale-[0.6] md:scale-90 lg:scale-125 xl:scale-150 rotate-45 lg:rotate-[50deg]">
...
export default React.memo(NameCubes)